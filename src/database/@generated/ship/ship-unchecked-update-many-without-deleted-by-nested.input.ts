...
export class ShipUncheckedUpdateManyWithoutDeletedByNestedInput {
    ...
    @Field(() => [ShipUpsertWithWhereUniqueWithoutDeletedByInput], {nullable:true})
    ...
    @Field(() => [ShipUpdateWithWhereUniqueWithoutDeletedByInput], {nullable:true})
    @Type(() => ShipUpdateWithWhereUniqueWithoutDeletedByInput)
    update?: Array<ShipUpdateWithWhereUniqueWithoutDeletedByInput>;

    @Field(() => [ShipUpdateManyWithWhereWithoutDeletedByInput], {nullable:true})
